...
const WHATSAPP_NUMBER = "917906850213";
...
export default function WhatsAppButton() {
  ...
  const defaultMessage =
    lang === "hi"
      ? "नमस्ते, मैं बीमा के बारे में जानकारी चाहता/चाहती हूँ।"
      : "Hello, I would like to know more about insurance plans.";
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="relative w-16 h-16 sm:w-20 sm:h-20 bg-[#25D366] rounded-full shadow-2xl
                     flex items-center justify-center cursor-pointer
                     hover:bg-[#20BA5A] transition-colors duration-300
