...
const testimonials = [
  ...
  { key: "test_4", name: "Priya Sharma", role: "Software Engineer" },
  { key: "test_5", name: "Rajesh Kumar", role: "Business Owner" },
  { key: "test_6", name: "Anita Singh", role: "Homemaker" },
];
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="flex w-max flex-nowrap animate-marquee gap-4 sm:gap-6 md:gap-8">
            {[...testimonials, ...testimonials].map((item, i) => {
              const testimonialText = t[item.key] || "";
              // Skip rendering if translation is missing
              if (!testimonialText) return null;
